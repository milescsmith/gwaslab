...
from gwaslab.qc.qc_reserved_headers import _get_headers, _reserved_headers_dict
...
def _prepare_metadata(meta: dict | None = None) -> dict[str, str]:
    ...
    try:
        ...
        if needs_type_cast:
            ...
            try:
                ...
                if verbose:
                    log.write("  -Filter applied after type casting", verbose=verbose)
        ...
        raise OSError(f"Failed to read GSF file: {e}") from e
