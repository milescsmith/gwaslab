...
from gwaslab.viz.viz_plot_mqqplot import _configure_fig_save_kwargs, _mqqplot, _process_p_value
...
def _gwheatmap(
    ...
    ychrpad: float = 0,
    use_rank: bool = False,
    xtick_chr_dict: dict[int, str] | None = None,
    ytick_chr_dict: dict[int, str] | None = None,
    fontsize: float = 10,
    add_b: bool = False,
    log: Log = Log(),
    ...
    **mqq_kwargs: Any
    ...
    log.write(f"Start to create genome-wide scatter plot...{_get_version()}:",verbose=verbose)
