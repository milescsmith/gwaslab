...
from gwaslab.io.io_process_kwargs import _extract_kwargs, _merge_and_sync_dic
...
def scatter(
    ...
    y: str,
    mode: str = "0",
    reg_box: dict[str, Any] | None = None,
    is_reg: bool = True,
    fdr: bool = False,
    ...
    helper_line_kwargs: dict[str, Any] | None = None,
    ...
    reg_xmin: float | None = None,
    verbose: bool = True,
    save_kwargs: dict[str, Any] | None = None,
    scatter_kwargs: dict[str, Any] | None = None,
    null_beta: float = 0,
    engine: str = "plt",
    xerr: Union[str, pd.Series, np.ndarray] | None = None,
    yerr: Union[str, pd.Series, np.ndarray] | None = None,
    **kwargs: Any
   ...
   # plot x=0,y=0, and a 45 degree line
    ...
    log.write(f" -Creating scatter plot : {x} - {y}...", verbose=verbose)
    if engine == "plt":
...
def confire_regression_line(
    ...
    helper_line_kwargs: dict[str, Any] | None,
    font_kwargs: dict[str, Any] | None,
    log: Log,
    verbose: bool,
    reg_xmin: float | None
) -> tuple["Axes", Any]:
...
def jackknife_r(df: pd.DataFrame, x: str, y: str, log: Log, verbose: bool) -> float:
    ...
    log.write(f" -R se (jackknife) = {r_se:.2e}", verbose=verbose)
    return r_se
