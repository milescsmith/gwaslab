...
from gwaslab.bd.bd_build import BUILD_DISPLAY_NAMES, BUILD_MAPPINGS
...
def check_species_compatibility(species: str | None, required_species: Union[str, list[str]], operation_name: str, log: Log | None = None, verbose: bool = True) -> bool:
    """
