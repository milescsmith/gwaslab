...
class Sumstats:
    ...
    @add_doc(_preformat)
    def __init__(self,
             sumstats: Union[str, pd.DataFrame] | None = None,
             fmt: str | None = None,
             tab_fmt: str = "tsv",
             snpid: str | None = None,
             rsid: str | None = None,
             ...
             readargs: dict[str, Any] | None = None,
             **kwreadargs: Any) -> None:
    ...
    @ldsc_h2_cts.setter
    def ldsc_h2_cts(self, value: Any | None) -> None:
    ...
    def ldsc_partitioned_h2_results(self, value: Any | None) -> None:
...
#### healper #################################################################################
    ...
    def liftover(self, to_build: str | None = None, from_build: str | None = None, chain_path: str | None = None, **kwargs: Any) -> None:
...
# utilities ############################################################################################################
    ...
    @add_doc(_mqqplot)
    @suppress_display
    def plot_mqq(self, build: str | None = None, **kwargs: Any) -> Any:
    ...
    @add_doc(_mqqplot)
    @suppress_display
    def plot_manhattan(self, build: str | None = None, **kwargs: Any) -> Any:
    ...
    @suppress_display
    def plot_snp_density(self, build: str | None = None, **kwargs: Any) -> Any:
    ...
    @add_doc(_plot_qq)
    @suppress_display
    def plot_qq(self, build: str | None = None, **kwargs: Any) -> Any:
    ...
    @suppress_display
    def plot_region(self, build: str | None = None, **kwargs: Any) -> Any:
    ...
    @suppress_display
    def plot_trumpet(self, build: str | None = None, **kwargs: Any) -> Any:
        fig = _plot_trumpet(
            self,
    ...
    @suppress_display
    def plot_phenogram(self, build: str | None = None, **kwargs: Any) -> Any:
    ...
    @add_doc(_get_sig)
    def get_lead(self, gls: bool = False, build: str | None = None, **kwargs: Any) -> Union[pd.DataFrame, "Sumstats"]:
