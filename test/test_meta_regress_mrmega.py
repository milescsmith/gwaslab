...
class TestMetaRegressMRMEGA(unittest.TestCase):
    ...
    def _diagnose_differences(self, python_result, original_result):
        ...
        print("   - Different markers selected for MDS calculation would lead to different PCs")
        print("   - Different PCs would lead to different regression results")
        print("   - MR-MEGA selects LAST marker encountered in each 1Mb bin")
        print("   - Marker order in input files affects which marker is 'last'")
            ...
            if "beta_1" in python_subset.columns and "beta_1" in original_subset.columns:
                ...
                if pc1_common.sum() > 0:
                    ...
                    if pc1_diff.abs().mean() > 0.1:
                        ...
                        print("   This suggests different markers were selected for MDS calculation.")
                        print("   Different MDS = different PCs = different regression results.")
        ...
        for n_variants in variant_counts:
            ...
            if python_results:
                ...
                if cpp_results:
                    ...
                    print("  C++:    Failed or not available")
